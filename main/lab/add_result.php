						...
						<form action="results.php" method="get">
							...
							if ($asas == 'CASHH') {
								...
								<select name="report_type" style="width: 270px; height:30px;">
									...
									include('connect.php');
									$result = $db->prepare("SELECT * FROM sales_order WHERE transdep='lab' and prescription_id= :userid");
								...
								<select name="report_type" style="width: 270px; height:30px;">
									...
									for ($i = 0; $row = $result->fetch(); $i++) {
										?>
										<option></option>
										<option value="<?php echo $row['test1']; ?>"><?php echo $row['test1']; ?></option>
										...
										<option value="<?php echo $row['test8']; ?>"><?php echo $row['test8']; ?></option>
							...
							<tbody>
								...
								for ($i = 0; $row = $result->fetch(); $i++) {
									...
									<tr class="record">
										...
										<td><?php echo $row['description1']; ?><br><?php echo $row['description2']; ?><br><?php echo $row['description3']; ?><br><?php echo $row['description4']; ?><br><?php echo $row['description']; ?><br><?php echo $row['description5']; ?><br><?php echo $row['description6']; ?><br><?php echo $row['description7']; ?><br><?php echo $row['description8']; ?><br><?php echo $row['description9']; ?><br><?php echo $row['description10']; ?><br>
										</td>


										<td>
											<a
												href="delete.php?id=<?php echo $row['diagnosis_report_id']; ?>&cashier=<?php echo $row['laboratorist_id']; ?>&patient_id=<?php echo $row['patient_id']; ?>&prescription_id=<?php echo $row['prescription_id']; ?>&insurance_id=<?php echo $row['insurance_id']; ?>&patient_name=<?php echo $row['patient_name']; ?>">
												Delete </a>
										</td>
									</tr>
									<?php
