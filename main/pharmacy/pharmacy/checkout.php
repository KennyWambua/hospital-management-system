...
<input type="text" size="25" value="" name="name" id="country" onKeyUp="suggest(this.value);" onBlur="fill();" class="" autocomplete="off" placeholder="Enter Customer Name" style="width: 268px;" /><br><br>
...
<option>EMBU UNIVERSITY COLLEGE</option>
<option>AON</option>
<option>CIC</option>
<option>KWS</option>
...
<option>INDIVIDUAL</option>
 ...
 <br>
<input type="text" name="number" placeholder="Member Number" style="width: 268px; margin-bottom: 15px;" /><br>
<input type="text" name="anumber" placeholder="Admission Number" style="width: 268px; margin-bottom: 15px;" /><br>
<input type="date" name="adate" placeholder="Admssion date" style="width: 268px; margin-bottom: 15px;" /><br>
<input type="date" name="ddate" placeholder="Discharge Date" style="width: 268px; margin-bottom: 15px;" /><br>
<input type="nhif" name="nhif" placeholder="Less NHIF Rebate" style="width: 268px; margin-bottom: 15px;" /><br>
