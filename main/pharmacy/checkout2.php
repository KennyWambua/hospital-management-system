...
<input type="text" size="25" value="" name="anumber" id="country" onKeyUp="suggest(this.value);" onBlur="fill();" class="" autocomplete="off" placeholder="Patient Number" style="width: 268px;" /><br><br>
