...
<table id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				$d2=$_GET['d2'];
				$s=$_GET['session'];
				$result = $db->prepare("SELECT * FROM salesr WHERE transdep IS NOT NULL  AND session=:s AND date BETWEEN :a AND :b " );
	...
	<thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> LAB TOTAL :</th>
    ...
    <thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> PHARMACY TOTAL: </th>
			<th colspan="2" style="border-top:1px solid #999999"> 
			<?php
    ...
    <thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> CONSULTATION: </th>
			<th colspan="2" style="border-top:1px solid #999999"> 
			<?php
    ...
    <thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> MCH: </th>
			<th colspan="2" style="border-top:1px solid #999999"> 
			<?php
    ...
    <thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> OPD: </th>
			<th colspan="2" style="border-top:1px solid #999999"> 
			<?php
    ...
    <thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> INPATIENT: </th>
			<th colspan="2" style="border-top:1px solid #999999"> 
			<?php
    ...
    <thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> OPTICAL: </th>
			<th colspan="2" style="border-top:1px solid #999999"> 
			<?php
    ...
    <thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> AMBULANCE: </th>
			<th colspan="2" style="border-top:1px solid #999999"> 
			<?php
    ...
    <thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> X-RAY: </th>
			<th colspan="2" style="border-top:1px solid #999999"> 
			<?php
    ...
    <thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> THEATRE: </th>
			<th colspan="2" style="border-top:1px solid #999999"> 
			<?php
    ...
    <thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> OPTICALS: </th>
			<th colspan="2" style="border-top:1px solid #999999"> 
			<?php
     ...
     <thead>
		<tr>
			<th colspan="5" style="border-top:1px solid #999999"> TOTAL DAILY COLLECTION: </th>
			<th colspan="2" style="border-top:1px solid #999999"> 
			<?php
