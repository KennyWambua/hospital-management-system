        ...
        <fieldset>
          <p style="margin-top: 40px;">
            ...
            <input type="text" id="login-username" style="width:200px; height:25px" align="middle"
              class="round full-width-input" placeholder="Username" name="username" autofocus />
          </p>
          <p>
            <label> Password </label>
            <input type="password" id="login-password" style="width:200px; height:25px" align="middle" name="password"
