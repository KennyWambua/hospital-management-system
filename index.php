...
<body>
	...
	<div align="center" id="content">
		<div class="formContainer" style="margin:100px auto;">
			<?php
			...
			<form action="login.php" method="POST" id="form1" class="cmxform" autocomplete="off">
				<fieldset>
					<p style="margin-top: 40px;">
						...
						<input type="text" id="login-username" style="width:200px; height:25px" align="middle"
							class="round full-width-input" placeholder="Enter Username" name="username" autofocus />
					</p>
					<p>
						<label> Password </label>
						<input type="password" id="login-password" style="width:200px; height:25px" align="middle"
							name="password" placeholder="Enter Password" class="round full-width-input" />
					</p>
